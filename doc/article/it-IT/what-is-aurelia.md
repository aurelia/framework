---
{
  "name": "Cosa è Aurelia?",
  "culture": "it-IT",
  "description": "Aurelia è un framework UI di nuova generazione. Whether you're building application for the browser, mobile o desktop, Aurelia ti consente non solo di create UI incredibili, ma anche di farlo in un modo that is maintainable, testable and extensible.",
