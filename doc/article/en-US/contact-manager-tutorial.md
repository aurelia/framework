...
> Note that we use a dashed naming convention to separate the words *contact-list*. The name of the class should be defined by using the UpperCammelCase version *ContactList*
